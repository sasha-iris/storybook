...
export const Interactive = {
  ...
  render: (args) => {
    const h='<div style="border:1px solid #e5e7eb;border-radius:12px;padding:20px;background:#fff;"><div>State: Loading</div></div>';
    const r='<div style={{border:"1px solid #e5e7eb",padding:"20px"}}>{state}</div>';
    const c='export function StateCard({state}){return(<div style={{border:"1px solid #e5e7eb"}}>{state}</div>);}';
    return `
