  ...
  render: ({ type, size, darkMode, showOverlay }) => {
    ...
    return `
      <div style="display:flex;flex-direction:column;gap:24px;">
        <div style="padding:16px;border:1px solid var(--color-border-default);border-radius:8px;position:relative;">
          ${preview}
        </div>
...
<div class="modal-dialog modal-dialog-xl">...</div>  <!-- 1024px -->`,
  ...
  render: () => `
    <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px;align-items:start;padding:32px;background:var(--color-text-primary);">
      ${[
