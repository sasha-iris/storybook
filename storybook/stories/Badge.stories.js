 ...
 * gray:   var(--color-bg-secondary) / #101828 / #6a7282
...
const BADGE_COLORS = {
  gray:   { bg: 'var(--color-bg-secondary)', text: '#101828', dismiss: '#6a7282' },
  ...
  render: ({ color }) => `
    <div style="display:flex;flex-direction:column;gap:16px;">
      <div style="display:flex;align-items:center;gap:16px;">
        <span style="width:32px;font:11px/1 sans-serif;color:var(--color-border-light);">lg</span>
        ${badge({ label: 'In review', color, size: 'lg' })}
      </div>
      <div style="display:flex;align-items:center;gap:16px;">
        <span style="width:32px;font:11px/1 sans-serif;color:var(--color-border-light);">sm</span>
