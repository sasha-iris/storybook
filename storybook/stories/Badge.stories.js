...
function badge({ label = 'Badge', color = 'indigo', size = 'lg', icon = false, dismissible = false }) {
  ...
  const isLg = size === 'lg';
  const fs = isLg ? '14px' : '12px';
  const fw = isLg ? '400' : '500';
...
<span style="display:inline-flex;align-items:center;gap:4px;background:#f3f4f6;color:#101828;font-size:14px;font-weight:400;border-radius:6px;padding:2px 12px;white-space:nowrap;line-height:1.5;">Neutral</span>

<!-- Green — success / active -->
<span style="display:inline-flex;align-items:center;gap:4px;background:#d0fae5;color:#006045;font-size:14px;font-weight:400;border-radius:6px;padding:2px 12px;white-space:nowrap;line-height:1.5;">Active</span>

<!-- Red — error / failed -->
<span style="display:inline-flex;align-items:center;gap:4px;background:#ffe2e2;color:#9f0712;font-size:14px;font-weight:400;border-radius:6px;padding:2px 12px;white-space:nowrap;line-height:1.5;">Failed</span>

<!-- Yellow — warning / pending -->
<span style="display:inline-flex;align-items:center;gap:4px;background:#fef9c2;color:#894b00;font-size:14px;font-weight:400;border-radius:6px;padding:2px 12px;white-space:nowrap;line-height:1.5;">Pending</span>`,
        language: 'html',
      },
    },
  },
...
**❌ Don't** — mix sizes within the same row — pick one and be consistent per context.
      ...
      source: {
        code: `<!-- lg (default) -->
<span style="display:inline-flex;align-items:center;gap:4px;background:#e5edff;color:#42389d;font-size:14px;font-weight:400;border-radius:6px;padding:2px 12px;white-space:nowrap;line-height:1.5;">In review</span>

<!-- sm (compact) -->
<span style="display:inline-flex;align-items:center;gap:4px;background:#e5edff;color:#42389d;font-size:12px;font-weight:500;border-radius:6px;padding:2px 10px;white-space:nowrap;line-height:1.5;">In review</span>`,
        language: 'html',
      },
    },
  },
...
**❌ Don't** — use the icon purely as decoration — it adds visual complexity without benefit.
      ...
      source: {
        code: `<span style="display:inline-flex;align-items:center;gap:4px;background:#e5edff;color:#42389d;font-size:14px;font-weight:400;border-radius:6px;padding:2px 12px;white-space:nowrap;line-height:1.5;">
