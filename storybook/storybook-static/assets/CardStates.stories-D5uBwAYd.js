import{I as t,c}from"./card-icons-DBPmoQzP.js";const M={title:"Iris Library/Card/States",tags:["autodocs","stable"],parameters:{layout:"padded",backgrounds:{default:"light"},docs:{description:{component:`**Card / States** — data-lifecycle states for all card variants.
...
**❌ Don't** — show an empty state and an error state with the same message.`}}},argTypes:{state:{control:{type:"radio",options:["loaded","loading","empty","error"]},description:"Active data state. Switch here to compare all four states without navigating between stories.",table:{category:"State",defaultValue:{summary:"loaded"}}},variant:{control:{type:"radio",options:["content","kpi","chart"]},description:"Card family to render the state against — `content` (text), `kpi` (metric), `chart` (sparkline).",table:{category:"State",defaultValue:{summary:"content"}}}},args:{state:"loaded",variant:"content"}},p={content:`
    ...
    <div class="card-body-padded">
      <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:10px;">
        ...
        <div class="card-icon card-icon-blue" style="flex-shrink:0;">${t.revenue}</div>
      </div>
    ...
    <div class="card-body-padded">
      <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:10px;">
        <div class="card-stat-label">Total Revenue</div>
        <div class="card-icon card-icon-blue" style="width:32px;height:32px;flex-shrink:0;">${c(t.revenue)}</div>
      </div>
    ...
    <div class="skeleton" style="height:60px;"></div>`},o={content:`
    <div class="card-body-padded" style="text-align:center;padding:40px 20px;">
      <div aria-hidden="true" style="margin-bottom:12px;display:flex;justify-content:center;color:var(--color-text-fg-disabled);">${t.inbox}</div>
    ...
    <div class="card-body-padded" style="text-align:center;padding:32px 20px;">
      <div aria-hidden="true" style="margin-bottom:8px;display:flex;justify-content:center;color:var(--color-text-fg-disabled);">${t.chart}</div>
      <div style="font-size:var(--text-sm);font-weight:var(--font-semibold);
    ...
    <div class="card-body-padded">
      <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:10px;">
        ...
        <div class="card-icon card-icon-green" style="width:32px;height:32px;flex-shrink:0;">${c(t.chart)}</div>
      </div>
      <div style="text-align:center;padding:12px 0 8px;">
        <div aria-hidden="true" style="margin-bottom:8px;">${t.inbox}</div>
    ...
    <div class="card-body-padded" style="text-align:center;padding:40px 20px;">
      <div aria-hidden="true"
           style="width:44px;height:44px;border-radius:50%;background:#FEE2E2;
                  display:flex;align-items:center;justify-content:center;
                  color:#991B1B;margin:0 auto 12px;">${t.warning}</div>
      <div style="font-size:var(--text-sm);font-weight:var(--font-semibold);
    ...
    <div class="card-body-padded" style="text-align:center;padding:24px 20px;">
      <div aria-hidden="true"
           style="width:36px;height:36px;border-radius:50%;background:#FEE2E2;
                  display:flex;align-items:center;justify-content:center;
                  color:#991B1B;margin:0 auto 10px;">${t.warning}</div>
      <div style="font-size:var(--text-xs);font-weight:var(--font-semibold);
    ...
    </div>`},e={name:"Interactive (Controls)",parameters:{backgrounds:{default:"white"},docs:{description:{story:"Primary QA story. Use `state` + `variant` Controls to switch between all four data states across content, KPI, and chart card types."},source:{language:"html",code:`<!-- Loading state: skeleton placeholders -->
<div class="card">
...
</div>`}}},render:({state:T,variant:l})=>{var v;const V=((v={loaded:p,loading:s,empty:o,error:r}[T])==null?void 0:v[l])??p.content;return`<div class="card" style="max-width:${l==="chart"?"400px":l==="kpi"?"260px":"380px"};">${V}</div>`}},i={name:"Loading (skeleton)",parameters:{backgrounds:{default:"white"},docs:{description:{story:"Skeleton placeholder state for content, KPI, and chart cards. Skeleton dimensions mirror the loaded content to minimise layout shift."},source:{language:"html",code:`<!-- Loading state: skeleton placeholders (content card example) -->
...
<div class="card" style="width:240px;">
  <div class="card-body-padded">
    ...
    </div>`},a={name:"Empty state",parameters:{backgrounds:{default:"white"},docs:{description:{story:"Zero-data state for content, KPI, and chart cards. Icon is decorative (aria-hidden). CTA is optional — only shown when there is a direct action the user can take."},source:{language:"html",code:`<!-- Empty state: content card (with CTA) -->
<div class="card" style="width:300px;">
  <div class="card-header">
...
<div class="card" style="width:240px;">
  <div class="card-body-padded" style="text-align:center;padding:32px 20px;">
    ...
    </div>`},n={name:"Error state",parameters:{backgrounds:{default:"white"},docs:{description:{story:"Fetch-failed state. Centred treatment for content/KPI cards; inline error banner for chart cards. Retry button must be keyboard-accessible."},source:{language:"html",code:`<!-- Error state: centred treatment (content / KPI cards) -->
<div class="card" style="width:300px;">
  <div class="card-header">
    <div class="card-header-title">Recent articles</div>
  </div>
...
<div class="card" style="width:380px;">
  ...
  <div style="height:60px;background:#FEF2F2;border-top:1px solid #FECACA;
        ...
        <div class="card-body-padded" style="text-align:center;padding:40px 20px;">
          <div aria-hidden="true"
               style="width:44px;height:44px;border-radius:50%;background:#FEF3C7;
                      display:flex;align-items:center;justify-content:center;
                      color:#92400E;margin:0 auto 12px;">${t.wifiOff}</div>
          <div style="font-size:var(--text-sm);font-weight:var(--font-semibold);
    ...
    </div>`},d={name:"All states — side by side",parameters:{backgrounds:{default:"light"},docs:{description:{story:"Loading / Empty / Error in one view. Use for design review — verify consistent card heights and no content leaks between states."},source:{language:"html",code:`<!-- All states side by side — 3-column grid -->
<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;max-width:780px;">
  ...
  <div>
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;max-width:780px;">
      ...
      <div>
        ...
        <div class="card">
          ...
          <div class="card-body-padded" style="text-align:center;padding:24px 16px;">
            <div aria-hidden="true" style="margin-bottom:8px;display:flex;justify-content:center;color:var(--color-text-fg-disabled);">${t.inbox}</div>
            <div style="font-size:var(--text-xs);font-weight:var(--font-semibold);
      ...
      <div>
        ...
        <div class="card">
          ...
          <div class="card-body-padded" style="text-align:center;padding:24px 16px;">
            <div aria-hidden="true" style="margin-bottom:8px;display:flex;justify-content:center;color:var(--color-text-fg-danger);">${t.xCircle}</div>
            <div style="font-size:var(--text-xs);font-weight:var(--font-semibold);
                        color:var(--color-text-heading);margin-bottom:4px;">Load failed</div>
            <div style="font-size:10px;color:var(--color-text-body-subtle);margin-bottom:10px;">
              Something went wrong.</div>
    ...
    </div>`};var x,h,g,y,m;e.parameters={...e.parameters,docs:{...(x=e.parameters)==null?void 0:x.docs,source:{originalSource:`{
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Primary QA story. Use \`state\` + \`variant\` Controls to switch between all four data states across content, KPI, and chart card types.'
      },
      source: {
        language: 'html',
...
<div class="card">
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Skeleton placeholder state for content, KPI, and chart cards. Skeleton dimensions mirror the loaded content to minimise layout shift.'
      },
      source: {
        language: 'html',
...
}`,...(f=(u=i.parameters)==null?void 0:u.docs)==null?void 0:f.source},description:{story:`Skeleton placeholders should match the loaded content dimensions as closely as possible
...
- Chart card footer (legend) also skeletonised`,...(k=(w=i.parameters)==null?void 0:w.docs)==null?void 0:k.description}}};var E,B,z,C,F;a.parameters={...a.parameters,docs:{...(E=a.parameters)==null?void 0:E.docs,source:{originalSource:`{
  name: 'Empty state',
  parameters: {
    backgrounds: {
      default: 'white'
    ...
    docs: {
      description: {
        story: 'Zero-data state for content, KPI, and chart cards. Icon is decorative (aria-hidden). CTA is optional — only shown when there is a direct action the user can take.'
      },
      source: {
        language: 'html',
...
}`,...(z=(B=a.parameters)==null?void 0:B.docs)==null?void 0:z.source},description:{story:`Zero-data state. Centered icon + heading + supporting text + optional CTA.
...
- Text hierarchy: semibold heading → secondary supporting copy`,...(F=(C=a.parameters)==null?void 0:C.docs)==null?void 0:F.description}}};var A,S,I,j,$;n.parameters={...n.parameters,docs:{...(A=n.parameters)==null?void 0:A.docs,source:{originalSource:`{
  name: 'Error state',
  parameters: {
    backgrounds: {
      default: 'white'
    ...
    docs: {
      description: {
        story: 'Fetch-failed state. Centred treatment for content/KPI cards; inline error banner for chart cards. Retry button must be keyboard-accessible.'
      },
      source: {
        language: 'html',
...
<div class="card" style="width:380px;">
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Loading / Empty / Error in one view. Use for design review — verify consistent card heights and no content leaks between states.'
      },
      source: {
        language: 'html',
...
}`,...(K=(P=d.parameters)==null?void 0:P.docs)==null?void 0:K.source},description:{story:`Loading → Empty → Error in a single row — one card type each.
...
- No content leaks between state columns`,...(N=(L=d.parameters)==null?void 0:L.docs)==null?void 0:N.description}}};const Q=["Interactive","Loading","Empty","Error","AllStates"];export{d as AllStates,a as Empty,n as Error,e as Interactive,i as Loading,Q as __namedExportsOrder,M as default};
