const t={bonnieGreen:"https://ui-avatars.com/api/?name=Bonnie+Green&size=96&background=e0e7ff&color=42389d&bold=true",appleWatch:"https://picsum.photos/seed/applewatch/275/174",neilSims:"https://ui-avatars.com/api/?name=Neil+Sims&size=32&background=dbeafe&color=1447e6&bold=true",bonnieGreenList:"https://ui-avatars.com/api/?name=Bonnie+Green&size=32&background=e0e7ff&color=42389d&bold=true",michealGough:"https://ui-avatars.com/api/?name=Micheal+Gough&size=32&background=d1fae5&color=065f46&bold=true",thomasLean:"https://ui-avatars.com/api/?name=Thomas+Lean&size=32&background=fef3c7&color=92400e&bold=true",lanaByrd:"https://ui-avatars.com/api/?name=Lana+Byrd&size=32&background=fce7f3&color=9d174d&bold=true",karenNelson:"https://ui-avatars.com/api/?name=Karen+Nelson&size=32&background=ede9fe&color=3730a3&bold=true",googlePlay:"https://cdn.simpleicons.org/googleplay/ffffff",appleLogo:"https://cdn.simpleicons.org/apple/ffffff",neilSimsTest:"https://ui-avatars.com/api/?name=Neil+Sims&size=32&background=dbeafe&color=1447e6&bold=true",michealGoughTest:"https://ui-avatars.com/api/?name=Micheal+Gough&size=32&background=d1fae5&color=065f46&bold=true",heleneEngels:"https://ui-avatars.com/api/?name=Helene+Engels&size=32&background=ede9fe&color=5b21b6&bold=true",karenNelsonTest:"https://ui-avatars.com/api/?name=Karen+Nelson&size=32&background=ede9fe&color=3730a3&bold=true",metamask:"https://placehold.co/18x17/E2761B/ffffff?text=M",coinbase:"https://cdn.simpleicons.org/coinbase/0052FF",opera:"https://cdn.simpleicons.org/opera/FF1B2D",walletconnect:"https://cdn.simpleicons.org/walletconnect/3B99FC",fortmatic:"https://placehold.co/16x16/7c3aed/ffffff?text=F"},fe="0 4px 6px -1px rgba(0,0,0,.1),0 2px 4px -2px rgba(0,0,0,.05)",u="0 1px 2px 0 rgba(0,0,0,.08)",a=`background:var(--color-bg-surface);border:1px solid var(--color-border-default);border-radius:8px;box-shadow:${fe}`,ge=`background:var(--color-bg-surface);border:1px solid var(--color-border-default);border-radius:8px;box-shadow:${u}`,ue=(n=!0)=>`<svg width="20" height="20" viewBox="0 0 20 20" fill="${n?"#155dfc":"#9ca3af"}" aria-hidden="true" style="flex-shrink:0;">
    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
  </svg>`,he=`<svg width="20" height="20" viewBox="0 0 20 20" fill="#FFDF20" aria-hidden="true">
  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
</svg>`,be='<svg width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="#155dfc" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M7.5 5l5 5-5 5"/></svg>',ve='<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#6b7280" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/></svg>',ye='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#6b7280" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 015.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>',we=`<svg width="16" height="16" viewBox="0 0 20 20" fill="#6b7280" aria-hidden="true" style="flex-shrink:0;">
  <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"/>
  <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"/>
</svg>`,ke={title:"Iris Library/Card/Layouts",tags:["autodocs","stable"],parameters:{layout:"padded",backgrounds:{default:"light"},docs:{description:{component:`
...
These Figma variants use \`border-radius: 8px\`, which differs from the \`var(--radius-xl, 16px)\` used by the \`.card\` CSS class in Card/Basics. Inline styles are used here for Figma parity.
  ...
  <div style="display:flex;gap:12px;justify-content:center;padding-top:24px;">
    ...
    <div style="${a};width:384px;padding:16px 16px 40px;">
      <!-- Three-dots menu -->
      ...
      <!-- Avatar + Name + Role -->
      <div style="display:flex;flex-direction:column;align-items:center;gap:12px;">
        <img src="${t.bonnieGreen}" alt="Bonnie Green"
    ...
    <div style="width:384px;padding:32px;background:#fff;border-radius:8px;
      ...
      <div style="display:flex;flex-direction:column;gap:20px;">
        ...
        <div class="form-group" style="margin-bottom:0;">
          <label class="form-label">Your email</label>
          <div style="position:relative;">
            <span style="position:absolute;left:12px;top:50%;transform:translateY(-50%);color:var(--color-text-secondary);">${we}</span>
            <input class="form-input" type="email" placeholder="name@flowbite.com" style="padding-left:36px;">
          </div>
        </div>
...
<div style="width:384px;background:var(--color-bg-surface);border:1px solid var(--color-border-default);border-radius:8px;
  ...
  <div style="display:flex;flex-direction:column;gap:20px;padding:0 20px 20px;">
    ...
    <div style="${a};width:384px;overflow:hidden;">

      <!-- Product image area -->
      <div style="display:flex;justify-content:center;align-items:center;padding:24px 16px;">
        <img src="${t.appleWatch}" alt="Apple Watch Series 7"
      ...
      <div style="display:flex;flex-direction:column;gap:20px;padding:0 20px 20px;">
        ...
        <div style="display:flex;flex-direction:column;gap:8px;">
          ...
          <div style="display:flex;align-items:center;gap:12px;">
            <div style="display:flex;gap:4px;">${he.repeat(5)}</div>
            <span style="background:#155dfc;color:#fff;font-size:var(--text-xs);font-weight:var(--font-semibold);
...
</div>`}}},render:()=>{const n=[{img:t.neilSims,name:"Neil Sims",email:"email@example.com",amount:"$367"},{img:t.bonnieGreenList,name:"Bonnie Green",email:"email@example.com",amount:"$67"},{img:t.michealGough,name:"Micheal Gough",email:"email@example.com",amount:"$3467"},{img:t.thomasLean,name:"Thomas Lean",email:"email@example.com",amount:"$2367"},{img:t.lanaByrd,name:"Lana Byrd",email:"email@example.com",amount:"$367"},{img:t.karenNelson,name:"Karen Nelson",email:"email@example.com",amount:"$1367"}];return`
    <div style="background:#fff;border-radius:8px;box-shadow:${u};
                width:384px;padding:32px;display:flex;flex-direction:column;gap:16px;">
      ...
      <div style="display:flex;flex-direction:column;">
        ${n.map((e,o)=>`
          ${o>0?'<div style="height:1px;background:#e5e7eb;"></div>':""}
          <div style="display:flex;align-items:center;padding:${o===n.length-1?"16px 0 0":"16px 0"};">
            <div style="display:flex;flex:1;align-items:center;gap:8px;min-width:0;">
              <img src="${e.img}" alt="${e.name}"
                   style="width:32px;height:32px;border-radius:100px;object-fit:cover;flex-shrink:0;">
              <div style="display:flex;flex-direction:column;min-width:0;">
                <span style="font-size:var(--text-base);font-weight:var(--font-semibold);color:#111928;line-height:1.5;">${e.name}</span>
                <span style="font-size:var(--text-xs);color:var(--color-text-secondary);line-height:1.5;">${e.email}</span>
              </div>
            </div>
            <span style="font-size:var(--text-base);font-weight:var(--font-semibold);color:#111928;line-height:1.5;
                         white-space:nowrap;">${e.amount}</span>
          </div>`).join("")}
      </div>

    </div>`}},p={name:"Pricing card",parameters:{controls:{disable:!0},docs:{description:{story:`
...
**Approximations:** Check-circle icons are inline SVG (Figma uses raster vectors at \`inset:10%\`).
        `},source:{language:"html",code:`<!-- Pricing card (384px, shadow-md) -->
<div style="width:384px;background:var(--color-bg-surface);border:1px solid var(--color-border-default);border-radius:8px;
  ...
  <div style="display:flex;flex-direction:column;gap:28px;align-items:center;">
...
</div>`}}},render:()=>{const n=["2 team members","20GB Cloud storage","Integration help"],e=["Sketch Files","API Access","Complete documentation","24×7 phone & email support"],o=(i,h)=>`
      <div style="display:flex;align-items:center;gap:12px;padding:2px 0;">
        ${ue(h)}
        <span style="font-size:var(--text-base);color:var(--color-text-secondary);line-height:1.5;
                     ${h?"":"text-decoration:line-through;"}">${i}</span>
      </div>`;return`
    <div style="${a};width:384px;padding:32px;overflow:hidden;">
      <div style="display:flex;flex-direction:column;gap:28px;align-items:center;">
    ...
    </div>`}},c={name:"CTA card",parameters:{controls:{disable:!0},docs:{description:{story:`
...
**Approximations:** App-store button icons use SimpleIcons CDN (stable, no TTL).
        `},source:{language:"html",code:`<!-- CTA card (790px, shadow-md) -->
<div style="width:790px;background:var(--color-bg-surface);border:1px solid var(--color-border-default);border-radius:8px;
  ...
  <div style="display:flex;flex-direction:column;gap:20px;align-items:center;text-align:center;">
    ...
    <div style="${a};width:790px;padding:32px;overflow:hidden;">
      <div style="display:flex;flex-direction:column;gap:20px;align-items:center;text-align:center;">
        ...
        <div style="display:flex;gap:16px;">
          ...
          <div style="display:flex;align-items:center;gap:10px;background:#111928;
                      padding:12px 16px;border-radius:8px;cursor:pointer;">
            <img src="${t.googlePlay}" alt="Google Play"
          ...
          <div style="display:flex;align-items:center;gap:10px;background:#111928;
                      padding:12px 16px;border-radius:8px;cursor:pointer;">
            <img src="${t.appleLogo}" alt="App Store"
                 style="width:38px;height:38px;object-fit:contain;flex-shrink:0;">
            <div style="display:flex;flex-direction:column;text-align:left;color:#fff;white-space:nowrap;">
              <span style="font-size:var(--text-xs);font-weight:400;line-height:12px;">Download on the</span>
...
<div style="width:790px;background:var(--color-bg-surface);border:1px solid var(--color-border-default);border-radius:8px;
  ...
  <div style="padding:32px;">
    ...
    <div style="${a};width:790px;overflow:hidden;">
...
</div>`}}},render:()=>{const n=[{value:"73M+",label:"Developers"},{value:"100M+",label:"Public repositories"},{value:"1000s",label:"Open source projects"},{value:"1B+",label:"Contributors"},{value:"90+",label:"Fortune 100 companies"},{value:"4M+",label:"Organizations"}],e=({value:o,label:i})=>`
      <div style="display:flex;flex-direction:column;align-items:center;flex:1;">
        <span style="font-size:30px;font-weight:800;color:#111928;line-height:1.25;">${o}</span>
        <span style="font-size:var(--text-base);font-weight:400;color:var(--color-text-secondary);line-height:1.5;">${i}</span>
      </div>`;return`
    <div style="${a};width:790px;overflow:hidden;">
      ...
      <div style="padding:32px;">
        <div style="padding:32px;display:flex;flex-direction:column;gap:32px;text-align:center;">
          <div style="display:flex;justify-content:space-between;">
            ${n.slice(0,3).map(e).join("")}
          </div>
          <div style="display:flex;justify-content:space-between;">
            ${n.slice(3).map(e).join("")}
          </div>
        </div>
      </div>

    </div>`}},f={name:"Testimonial card",parameters:{controls:{disable:!0},docs:{description:{story:`
...
**QA** — Cell padding: 32 px · Title: 18 px semibold \`#111928\` · Quote: 16 px regular \`#6b7280\`, text-center · Author avatar: 32 px circle, \`border: 1px solid #e5e7eb\` · Author name: 18 px semibold · Author role: 14 px medium · Shadow: shadow-sm (lighter than shadow-md cards).
        `},source:{language:"html",code:`<!-- Testimonial card (790px, shadow-sm) -->
<div style="width:790px;background:var(--color-bg-surface);border:1px solid var(--color-border-default);border-radius:8px;
...
</div>`}}},render:()=>{const n=[{img:t.neilSimsTest,name:"Neil Sims",role:"CEO, Flowbite",title:"Solid foundation for any project",quote:'If you care for your time, I hands down would go with this."'},{img:t.michealGoughTest,name:"Micheal Gough",role:"CEO, Flowbite",title:"Perfect choice for a SaaS application",quote:'Designing with Figma components that can be easily translated to the utility classes of Tailwind CSS is a huge timesaver!"'},{img:t.heleneEngels,name:"Helene Engels",role:"CEO, Flowbite",title:"Mindblowing workflow",quote:'Aesthetically, the well designed components are beautiful and will undoubtedly level up your next application."'},{img:t.karenNelsonTest,name:"Karen Nelson",role:"CEO, Flowbite",title:"Efficient Collaborating",quote:'You have many examples that can be used to create a fast prototype for your team."'}],e=(o,i)=>`
      <div style="flex:1;display:flex;flex-direction:column;justify-content:center;
                  padding:32px;${i}">
        <div style="display:flex;flex-direction:column;gap:24px;align-items:center;">
          ...
          <div style="display:flex;align-items:center;gap:16px;justify-content:center;">
            ...
            <div style="display:flex;flex-direction:column;gap:4px;white-space:nowrap;">
              <span style="font-size:18px;font-weight:600;color:#111928;line-height:1.25;">${o.name}</span>
              <span style="font-size:var(--text-sm);font-weight:var(--font-medium);color:var(--color-text-secondary);line-height:1.25;">${o.role}</span>
            </div>
          </div>
        </div>
      </div>`;return`
    <div style="${ge};width:790px;overflow:hidden;border-radius:8px;">
      <!-- Row 1 -->
      <div style="display:flex;border-radius:8px 8px 0 0;overflow:hidden;">
        ${e(n[0],"")}
        <div style="width:1px;background:#e5e7eb;flex-shrink:0;"></div>
...
<div style="background:#fff;border-radius:8px;box-shadow:0 1px 2px 0 rgba(0,0,0,.08);
  ...
  <div style="display:flex;align-items:center;gap:6px;">
...
</div>`}}},render:()=>{const n=[{img:t.metamask,name:"MetaMask",w:18,h:17,popular:!0},{img:t.coinbase,name:"Coinbase Wallet",w:16,h:16,popular:!1},{img:t.opera,name:"Opera Wallet",w:16,h:16,popular:!1},{img:t.walletconnect,name:"WalletConnect",w:18,h:18,popular:!1},{img:t.fortmatic,name:"Fortmatic",w:16,h:16,popular:!1}];return`
    <div style="background:#fff;border-radius:8px;box-shadow:${u};
                width:384px;padding:24px;display:flex;flex-direction:column;gap:16px;">
          ...
          ${n.map(e=>`
            <div style="display:flex;align-items:center;gap:12px;background:var(--color-bg-default);
              ...
              <div style="display:flex;flex:1;align-items:center;gap:12px;min-width:0;">
                <img src="${e.img}" alt="${e.name}"
                     style="width:${e.w}px;height:${e.h}px;object-fit:contain;flex-shrink:0;">
                <span style="font-size:var(--text-base);font-weight:700;color:#111928;line-height:1.5;">
                  ${e.name}
                </span>
              </div>
              ${e.popular?`<span style="background:#e5e7eb;font-size:var(--text-xs);font-weight:var(--font-medium);
    ...
    </div>`}};var b,v,y,w,k;r.parameters={...r.parameters,docs:{...(b=r.parameters)==null?void 0:b.docs,source:{originalSource:`{
...
}`,...(y=(v=r.parameters)==null?void 0:v.docs)==null?void 0:y.source},description:{story:`Centered avatar, name/role, "Add friend" + "Message" buttons.
...
- Card pt-16px px-16px pb-40px (asymmetric padding — more space at bottom)`,...(k=(w=r.parameters)==null?void 0:w.docs)==null?void 0:k.description}}};var S,C,z,A,D;s.parameters={...s.parameters,docs:{...(S=s.parameters)==null?void 0:S.docs,source:{originalSource:`{
...
}`,...(z=(C=s.parameters)==null?void 0:C.docs)==null?void 0:z.source},description:{story:`Sign-in form card: email input, password input, remember-me checkbox,
...
- "Lost Password?" color: #155dfc (blue/600), not brand purple`,...(D=(A=s.parameters)==null?void 0:A.docs)==null?void 0:D.description}}};var $,T,P,B,j;l.parameters={...l.parameters,docs:{...($=l.parameters)==null?void 0:$.docs,source:{originalSource:`{
...
}`,...(P=(T=l.parameters)==null?void 0:T.docs)==null?void 0:P.source},description:{story:`Product card: centered product image, title, 5 stars + rating badge, price + cart CTA.
...
- "Add to cart": bg #42389d (brand/800), rounded-12px, 14px medium white, h-36px`,...(j=(B=l.parameters)==null?void 0:B.docs)==null?void 0:j.description}}};var F,G,M,I,N;d.parameters={...d.parameters,docs:{...(F=d.parameters)==null?void 0:F.docs,source:{originalSource:`{
  name: 'Card with list',
  parameters: {
    controls: {
      disable: true
...
<div style="background:#fff;border-radius:8px;box-shadow:0 1px 2px 0 rgba(0,0,0,.08);
  ...
  render: () => {
    const customers = [{
      ...
      img: IMG.bonnieGreenList,
      name: 'Bonnie Green',
      email: 'email@example.com',
      amount: '$67'
    }, {
      img: IMG.michealGough,
      name: 'Micheal Gough',
      email: 'email@example.com',
      amount: '$3467'
    }, {
...
}`,...(M=(G=d.parameters)==null?void 0:G.docs)==null?void 0:M.source},description:{story:`"Latest Customers" list card: header with View-all link + 6 avatar rows.
...
- Title "Latest Customers": 18px extrabold #111928`,...(N=(I=d.parameters)==null?void 0:I.docs)==null?void 0:N.description}}};var L,W,E,H,Q;p.parameters={...p.parameters,docs:{...(L=p.parameters)==null?void 0:L.docs,source:{originalSource:`{
  name: 'Pricing card',
  parameters: {
    controls: {
      disable: true
...
}`,...(E=(W=p.parameters)==null?void 0:W.docs)==null?void 0:E.source},description:{story:`Pricing plan card: plan name, price, feature checklist (enabled + disabled), CTA button.
...
**Approximations:** Check-circle icons are inline SVG (Figma uses raster vectors).`,...(Q=(H=p.parameters)==null?void 0:H.docs)==null?void 0:Q.description}}};var V,R,O,q,_;c.parameters={...c.parameters,docs:{...(V=c.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: 'CTA card',
  parameters: {
    controls: {
      disable: true
...
}`,...(O=(R=c.parameters)==null?void 0:R.docs)==null?void 0:O.source},description:{story:`Wide CTA card: centered heading + body, two app-download buttons (Google Play, App Store).
...
- Button text: two lines — "Download on the" (12px reg) + brand name (18px bold)`,...(_=(q=c.parameters)==null?void 0:q.docs)==null?void 0:_.description}}};var K,Y,U,J,X;x.parameters={...x.parameters,docs:{...(K=x.parameters)==null?void 0:K.docs,source:{originalSource:`{
  name: 'Nav tabs card',
  parameters: {
    controls: {
      disable: true
...
}`,...(U=(Y=x.parameters)==null?void 0:Y.docs)==null?void 0:U.source},description:{story:`Card with a simple top-tab navigation bar + body copy + "Learn more" link.
...
**Approximations:** Chevron-right is inline SVG.`,...(X=(J=x.parameters)==null?void 0:J.docs)==null?void 0:X.description}}};var Z,ee,te,ne,oe;m.parameters={...m.parameters,docs:{...(Z=m.parameters)==null?void 0:Z.docs,source:{originalSource:`{
...
}`,...(te=(ee=m.parameters)==null?void 0:ee.docs)==null?void 0:te.source},description:{story:`Segmented tab navigation + 2×3 statistics grid.
...
- Stats grid: 2 rows × 3 columns, gap 32px`,...(oe=(ne=m.parameters)==null?void 0:ne.docs)==null?void 0:oe.description}}};var ie,ae,re,se,le;f.parameters={...f.parameters,docs:{...(ie=f.parameters)==null?void 0:ie.docs,source:{originalSource:`{
...
}`,...(re=(ae=f.parameters)==null?void 0:ae.docs)==null?void 0:re.source},description:{story:`2×2 testimonial grid: quote title + body text + author avatar/name/role.
...
- Overall shadow: shadow-sm (lighter)`,...(le=(se=f.parameters)==null?void 0:se.docs)==null?void 0:le.description}}};var de,pe,ce,xe,me;g.parameters={...g.parameters,docs:{...(de=g.parameters)==null?void 0:de.docs,source:{originalSource:`{
...
}`,...(ce=(pe=g.parameters)==null?void 0:pe.docs)==null?void 0:ce.source},description:{story:`Wallet-connect card: heading + description, 5 wallet rows, helper text.
...
- Question-circle is inline SVG`,...(me=(xe=g.parameters)==null?void 0:xe.docs)==null?void 0:me.description}}};const Se=["UserProfileCard","WithFormInputs","EcommerceCard","CardWithList","PricingCard","CTACard","NavTabsCard","StatsCard","TestimonialCard","CryptoCard"];export{c as CTACard,d as CardWithList,g as CryptoCard,l as EcommerceCard,x as NavTabsCard,p as PricingCard,m as StatsCard,f as TestimonialCard,r as UserProfileCard,s as WithFormInputs,Se as __namedExportsOrder,ke as default};
