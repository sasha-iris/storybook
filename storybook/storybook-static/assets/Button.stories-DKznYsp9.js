...
`),table:{category:"Appearance",defaultValue:{summary:"primary"}}},size:{control:"select",options:["xs","sm","md","lg","xl"],description:"Figma sizes: xs (34px h) · sm (36px) · md / base (40px) · lg / l (48px) · xl (52px).",table:{category:"Appearance",defaultValue:{summary:"md"}}},outline:{control:"boolean",description:"Outline / ghost mode. Swaps `.btn-{color}` for `.btn-outline-{color}`. Background becomes transparent.",table:{category:"Appearance",defaultValue:{summary:!1}}},pill:{control:"boolean",description:"Full pill border-radius via `.btn-pill`. Default radius is 12px (`--radius-lg`).",table:{category:"Appearance",defaultValue:{summary:!1}}},disabled:{control:"boolean",description:'Disabled state — 50% opacity, `pointer-events: none`. Adds `disabled` + `aria-disabled="true"` attributes.',table:{category:"State",defaultValue:{summary:!1}}}},args:{label:"Button text",color:"primary",size:"md",outline:!1,pill:!1,disabled:!1,iconLeft:!1,iconRight:!1,iconOnly:!1}},q={xs:16,sm:16,md:20,lg:20,xl:20},G=e=>`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
  ...
  <path fill-rule="evenodd"
    ...
    clip-rule="evenodd"/>
</svg>`,o=({label:e="Button text",color:n="primary",size:t="md",outline:a=!1,pill:r=!1,disabled:l=!1,iconLeft:s=!1,iconRight:d=!1,iconOnly:i=!1})=>{const h=["btn",a?`btn-outline-${n}`:`btn-${n}`,`btn-${t}`,r?"btn-pill":"",i?"btn-icon":""].filter(Boolean).join(" "),c=q[t]||20,p=s||i?G(c):"",H=d&&!i?W(c):"",V=i?"":`<span>${e}</span>`;return`<button class="${h}"${l?' disabled aria-disabled="true"':""}
    aria-label="${i?e:""}"
  >${p}${V}${H}</button>`},b={name:"Interactive (Controls)",render:e=>{const n=e,a=["btn",n.outline?`btn-outline-${n.color}`:`btn-${n.color}`,`btn-${n.size}`,n.pill?"btn-pill":"",n.iconOnly?"btn-icon":""].filter(Boolean).join(" ");let r="",l="",s="";if(n.iconOnly)r=`<button class="${a}" aria-label="${n.label}">
  <!-- icon svg here -->
</button>`,l=`<button className="${a}" aria-label="${n.label}">
  {/* icon here */}
</button>`,s=`export function ${a.split(" ")[1].charAt(0).toUpperCase()+a.split(" ")[1].slice(1)}({ label, onClick, disabled }) {
  return (
    <button
      className="${a}"
      aria-label={label}
...
}`;else{const h=n.iconLeft?`
  {/* left icon */}`:"",c=n.iconRight?`
  {/* right icon */}`:"",p=n.disabled?' disabled aria-disabled="true"':"";r=`<button class="${a}"${p}>
  <span>${n.label}</span>${n.iconLeft?`
  <!-- left icon -->`:""}${n.iconRight?`
  <!-- right icon -->`:""}
</button>`,l=`<button className="${a}"${p}>${h}
  <span>${n.label}</span>${c}
</button>`,s=`export function Button({ label = "${n.label}", onClick, disabled = ${n.disabled} }) {
  return (
    <button
      className="${a}"
      onClick={onClick}
...
}`}const d=r.replace(/</g,"&lt;").replace(/>/g,"&gt;"),i=l.replace(/</g,"&lt;").replace(/>/g,"&gt;"),v=s.replace(/</g,"&lt;").replace(/>/g,"&gt;");return`
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:40px;align-items:start;">
        ...
        <div style="display:flex;flex-direction:column;gap:24px;">
          ...
          <div style="padding:20px;border:1px solid #e5e7eb;border-radius:8px;">
            ...
            <button data-copy="${s.split('"').join("&quot;")}" class="storybook-copy-btn" style="padding:8px 12px;background:#f3f4f6;color:#374151;border:1px solid #d1d5db;border-radius:4px;cursor:pointer;font-family:inherit;font-size:12px;font-weight:500;display:flex;align-items:center;gap:6px;">
              <svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5">
                <rect x="2" y="2" width="8" height="8" rx="1"/>
                <path d="M6 14H12C13.1046 14 14 13.1046 14 12V6"/>
              </svg>
...
<button className="btn btn-outline-dark btn-md">Dark</button>`,language:"jsx"}}},render:({size:e})=>`
    ...
    </div>`},m={name:"Sizes — xs to xl",args:{color:"primary",outline:!1},parameters:{controls:{include:["color","outline"]},docs:{description:{story:`
...
<button className="btn btn-primary btn-xl">xl</button>`,language:"jsx"}}},render:({color:e,outline:n})=>`
    ...
    </div>`},x={name:"States — default / disabled",args:{size:"md"},parameters:{controls:{include:["size"]},docs:{description:{story:`
...
<button className="btn btn-primary btn-icon btn-md" aria-label="Action">
  <StarIcon className="w-5 h-5" />
    ...
    </div>`},g={name:"Pill — rounded corners",args:{size:"md"},parameters:{controls:{include:["size"]},docs:{description:{story:"Full pill border-radius via `.btn-pill`. Use **size** to see pill at any size."},source:{code:`<button className="btn btn-primary btn-pill btn-md">Primary</button>
<button className="btn btn-outline-primary btn-pill btn-md">Primary outline</button>`,language:"jsx"}}},render:({size:e})=>`
    ...
    </div>`},f={name:"Disabled state",args:{size:"md"},parameters:{controls:{include:["size"]},docs:{description:{story:"Disabled renders at 50% opacity with `pointer-events: none`. Use **size** to verify across sizes."},source:{code:`<button className="btn btn-primary btn-md" disabled aria-disabled="true">Disabled</button>
<button className="btn btn-outline-primary btn-md" disabled aria-disabled="true">Outline disabled</button>`,language:"jsx"}}},render:({size:e})=>`
    ...
    </div>`};var w,$,C;b.parameters={...b.parameters,docs:{...(w=b.parameters)==null?void 0:w.docs,source:{originalSource:`{
...
}`,...(C=($=b.parameters)==null?void 0:$.docs)==null?void 0:C.source}}};var k,z,A;u.parameters={...u.parameters,docs:{...(k=u.parameters)==null?void 0:k.docs,source:{originalSource:`{
...
}`,...(A=(z=u.parameters)==null?void 0:z.docs)==null?void 0:A.source}}};var N,B,S;m.parameters={...m.parameters,docs:{...(N=m.parameters)==null?void 0:N.docs,source:{originalSource:`{
  name: 'Sizes — xs to xl',
  args: {
    color: 'primary',
    outline: false
...
}`,...(S=(B=m.parameters)==null?void 0:B.docs)==null?void 0:S.source}}};var j,D,I;x.parameters={...x.parameters,docs:{...(j=x.parameters)==null?void 0:j.docs,source:{originalSource:`{
...
}`,...(I=(D=x.parameters)==null?void 0:D.docs)==null?void 0:I.source}}};var L,U,O;y.parameters={...y.parameters,docs:{...(L=y.parameters)==null?void 0:L.docs,source:{originalSource:`{
  name: 'With Icons',
  args: {
    color: 'primary',
    size: 'md'
...
}`,...(O=(U=y.parameters)==null?void 0:U.docs)==null?void 0:O.source}}};var R,E,F;g.parameters={...g.parameters,docs:{...(R=g.parameters)==null?void 0:R.docs,source:{originalSource:`{
...
}`,...(F=(E=g.parameters)==null?void 0:E.docs)==null?void 0:F.source}}};var T,M,P;f.parameters={...f.parameters,docs:{...(T=f.parameters)==null?void 0:T.docs,source:{originalSource:`{
  name: 'Disabled state',
  args: {
    size: 'md'
  },
...
}`,...(P=(M=f.parameters)==null?void 0:M.docs)==null?void 0:P.source}}};const Q=["Interactive","FigmaColors","FigmaSizes","FigmaStates","IconPlacement","Pill","Disabled"];export{f as Disabled,u as FigmaColors,m as FigmaSizes,x as FigmaStates,y as IconPlacement,b as Interactive,g as Pill,Q as __namedExportsOrder,_ as default};
